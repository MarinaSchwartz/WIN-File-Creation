...
## After running code in TN STACKED written file Abs and Result Value columns need to be changed to numeric and decimals adjusted (abs = 0.0000 nad result value is whole numbers)

...
Stacked <- read_xlsx("/Users/mevanskeene/Desktop/Q1 2025 Data from ZL/Secchi and CHLs/CHL and Secchi Q1.xlsx", sheet = 1, col_types = "text")
...
CHL$Org_Result_Value <- round(CHL$Org_Result_Value, 2)
...
write.table(CHL, file = "Data/LW/Secchi_STACKED.csv", sep = ",", na = "", row.names = FALSE, quote = FALSE)

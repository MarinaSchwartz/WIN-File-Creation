...
folder_path <- "/Users/mevanskeene/Desktop/Q1 2025 Data from ZL/Cond"
...
read_as_text <- function(file) {
  ...
  df$'Org Result Value' <- as.numeric(df$'Org Result Value')
  df$'Org Result Value' <- round(df$'Org Result Value', 2)
